package com.andresochoahernandez.verotest.configuration.database;
...
@EnableJpaRepositories(
        ...
        basePackages            = {"com.andresochoahernandez.verotest.repository.agents"}
)
public class AgentsDatabaseConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean agentsDatabaseEntityManagerFactory(@Qualifier("agentsDatabaseDataSource")DataSource dataSource, EntityManagerFactoryBuilder builder){
        ...
        return builder.dataSource(dataSource).packages("com.andresochoahernandez.verotest.model.agents").properties(props).build();
    }
    @Bean
